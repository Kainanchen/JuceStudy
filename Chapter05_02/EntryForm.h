...
private:
    ...
    //==============================================================================
    ScopedPointer<GroupComponent> address;
    ScopedPointer<Label> Line1;
    ScopedPointer<Label> Line3;
    ScopedPointer<Label> Age;
    ScopedPointer<Label> Line2;
    ScopedPointer<Label> LastName;
    ScopedPointer<Label> FirstName;
